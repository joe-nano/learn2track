...
def test_gru_mixture_track_neighborhood():
    hidden_sizes = 50
...
def test_gru_mixture_track_stopping():
    hidden_sizes = 50
...
if __name__ == "__main__":
    test_gru_mixture_track()
    test_gru_mixture_track_neighborhood()
    test_gru_mixture_track_stopping()
